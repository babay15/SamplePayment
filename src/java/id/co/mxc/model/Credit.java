...
@NamedQueries({
    ...
    , @NamedQuery(name = "Credit.findByCreditStatusAndFlag", query = "SELECT c FROM Credit c WHERE c.creditStatus = :creditStatus AND c.creditFlag = :creditFlag")})
public class Credit implements Serializable {
    ...
    public String toString() {
        return "id.co.mxc.model.Credit[ creditId=" + creditId + " ]";
    }
