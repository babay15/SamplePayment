...
public class CreditFormBean {
    ...
    public void setCreditTotal() {
        this.creditTotal = creditBasePrice + (creditBasePrice * creditInterestRate);
    }
     ...
     */
    public void setCreditMonthlyInstallment() {
        this.creditMonthlyInstallment = ((creditBasePrice +(creditBasePrice * creditInterestRate))-creditDownPayment) / creditDuration;
    }
